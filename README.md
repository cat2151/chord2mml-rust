...
- **CST→AST Conversion**: Transforms CST (Concrete Syntax Tree) generated by Tree-sitter into AST (Abstract Syntax Tree)
...
### Phase 1: Basic Tree-sitter based implementation ✅
